 ...
 * 区別できない**。実測(2026-08-10): GitHub の README について訊いた回は、内容の合っている答えが
...
- **\`site:\` や \`inurl:\` が通るのは \`web\` だけ。** 他は検索エンジンではなく各サイトの API で、
  GitHub は不正な絞り込みとして断り、他は語として読む(実測 2026-08-11: 9回中9回落ちた)。
...
- 実測(2026-08-10)で、検索だけの答えは npm の最新版を **3.22.0** と返した。一次資料
  (\`registry.npmjs.org/effect\`)には **3.22.1**、公開は 2026-07-30 とあった。日付まで違っていた。
