 ...
 * 従量課金に戻る。famulus-zero が 2026-08-07 にわざわざ捨てた経路がそれ。
 *
 * ## ツール呼び出しの搬送
...
function toolInstruction(context: PiContext): string {
  ...
  return [
    ...
    // そこで「使えない」と結論して toolCalls を空のまま返す(実測 2026-08-10、haiku・同一問い n=10):
    ...
    // 実測(2026-08-10、`--tools ""` で封じた素の CLI に「呼べるツールを列挙して」と訊いた):
 ...
 * 手ぶらで戻ってくることがある(実測 2026-08-10、旧い言い回しで haiku 8/10)。
