/** 止めるべきものを止めることと、止めなくていいものを通すことの両方を見る。何も出せない検査は外されるため。 */
...
/** 本文に無い一節を引いた指摘は直しようが無く、下書きが止まり続けるので、コードが捨てる。 */
const BODY = "cycle を20回走らせたら、18回は別の枠へ出ていた。\n親が使ったのは2回だけ。"
...
/** 精査役が何も返さなかった回と指摘が無かった回を区別するため、「出す」と書かれた回だけを通す。 */
